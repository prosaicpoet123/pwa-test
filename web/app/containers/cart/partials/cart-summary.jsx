...
import {iOSBrowser, isSamsungBrowser} from 'progressive-web-sdk/dist/utils/utils'
...
const CartSummary = ({
    ...
    const paymentRequestEnabled = window.PaymentRequest &&
        ...
        // Temporarily disable PRAPI on all iOS and Samsung devices, even versions that have PRAPI support
        // Adding support on Samsung requires further testing
