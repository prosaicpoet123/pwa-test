...
import {setIsServerSideOrHydratingFlag, setviewportSizeValue} from 'progressive-web-sdk/dist/store/app/actions'
...
import {calculateViewportSize} from '../../utils/universal-utils'
import {VIEWPORT_SIZE_NAMES} from '../../utils/ssr/constants'
...
class App extends React.Component {
    ...
    componentDidMount() {
        ...
        if (!this.props.isServerSide) {
            this.props.setIsServerSideOrHydratingFlag(false)
...
App.propTypes = {
    ...
    */
    ...
    setIsServerSideOrHydratingFlag: PropTypes.func,
...
const mapDispatchToProps = {
    ...
    setIsServerSideOrHydratingFlag,
