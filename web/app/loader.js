/* global AJS_SLUG, NATIVE_WEBPACK_ASTRO_VERSION, MESSAGING_SITE_ID, SITE_NAME, MESSAGING_ENABLED, DEBUG, WEBPACK_NON_PWA_ENABLED, AMP_LINKING_ENABLED, AstroNative */
...
const loadPWA = () => {
    ...
    const previewEnabledBuildInAstroAndroid = isRunningInAstroAndroid && AstroNative.Configuration.ASTRO_PREVIEW && !/^cdn\.mobify\.com/.test(getAssetUrl(''))
    ...
    (('serviceWorker' in navigator && !previewEnabledBuildInAstroAndroid)
    ...
    if (
        ...
        Promise.all(
            ...
            [
                ...
                triggerSandyAppStartEvent(false, AJS_SLUG),
